			...
			<main className="flex-1">
					...
					<div className="grid items-center gap-12 lg:grid-cols-2">
						<div>
							...
							<h1 className="mt-4 text-display-md text-ink sm:text-display-lg lg:text-display-xl">
								...
								<span className="">Zenhabits</span>.
							</h1>
							<p className="mt-6 max-w-lg text-body-lg text-ink-subtle">
								<b>ZenHabits</b> brings your tasks, study plans,
								calendar reminders, job applications, work
								sessions, and finances into one calm, focused
								workspace.
							</p>
				...
				<section className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6">
					...
					<p className="mt-3 max-w-xl text-body-lg text-ink-subtle">
						Each feature is deliberately simple. No dashboards to
						configure, no settings to learn.
					</p>
					...
					<Card className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-6">
						...
						<div>
							...
							<p className="mt-2 max-w-2xl text-body-sm text-ink-subtle">
								ZenHabits is web-first for now. An Android app
								is planned for a later phase, so your data will
								be waiting when it arrives.
							</p>
						</div>
					</Card>
				</section>
